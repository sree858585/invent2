<template>
            ...
            <table class="modern-table">
                ...
                <tbody>
                    <tr v-for="course in courses" :key="course.courseSysId">
                        ...
                        <td>
                            <button class="btn-primary" @click="selectCourse(course)">Select</button>
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    <ViewAttendanceModal v-if="selectedCourse"
...
import ViewAttendanceModal from '@/components/Modals/ViewAttendanceModal.vue'

// Reactive variable to hold the selected course
const selectedCourse = ref(null)

// Lookup & pagination data
const courses = ref([])
const formats = ref([])
const regions = ref([])
const sites = ref([])
...
// Load dropdown values (lookup tables)
...
// Show the ViewAttendanceModal for selected course
