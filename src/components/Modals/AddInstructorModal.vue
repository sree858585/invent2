            ...
            <form @submit.prevent="submitInstructor">
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <textarea v-model="form.notes" placeholder="Optional notes about the instructor"></textarea>
                    </div>
    ...
    export default {
        ...
        async mounted() {
            try {
                ...
                alert("Failed to load training center options.");
            }
        },
        methods: {
            async submitInstructor() {
                try {
                    const payload = {
                        name: this.form.name,
                        siteSysId: parseInt(this.form.siteSysId),
                    ...
                    await apiClient.post("/InstructorManagement/create", payload);
